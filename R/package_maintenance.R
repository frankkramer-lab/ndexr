...
#'
#' @examples
#' \dontrun{readYamlToRFile('R/ndex_api_conf.yml', 'R/ndex_api_conf.r', ndex.api.conf.header)}
...
## readYamlToRFile('R/ndex_api_conf.yml', 'R/ndex_api_conf.r', ndex.api.conf.header)
