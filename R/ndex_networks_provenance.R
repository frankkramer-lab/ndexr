...
#' @section REST query:
#' GET: ndex.api.config$api$network$provenance$get
...
#' provenance = ndex.network.get.provenance(ndexcon, nuuid) }
#' @export
ndex.network.get.provenance <- function(ndexcon, nuuid){
...
#' networks = ndex.find.networks(ndexcon,"p53")
#' nuuid = networks[1,"externalId"]
#' provenance = ndex.network.set.provenance(ndexcon, nuuid, provenance) }
ndex.network.set.provenance <- function(ndexcon, nuuid, provenance){	
