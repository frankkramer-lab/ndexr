...
Installation via GitHub using [*devtools*](http://cran.r-project.org/web/packages/devtools/index.html) R package
```{r, eval=FALSE}
require(devtools)
...
Afterwards `ndex_find_networks` retrieves a list of networks of user `nci-pid`, which contains the data of the Pathway Interaction Database. The function `ndex_get_network` downloads the network data and stores in the `RCX` format (explained in the next section) and is then converted into an igraph-based object via `rcx_toRCXgraph`.
...
the corresponding version.
  ...
  ***Networks***
  ndex_find_networks                  no                   X                 X                 X
  ndex_network_get_summary            no                   X                 X                 X
  ndex_get_network                    no                   X                 X                 X
  ndex_create_network                 yes                  X                 X                 X
  ndex_update_network                 yes                  X                 X                 X
  ndex_delete_network                 yes                  X                 X                 X
  ndex_network_get_metadata           no                   X                 X                 (x)
  ndex_network_aspect_get_metadata    no                   (x)               (x)               
  ndex_network_get_aspect             no                   X                 X                 (x)
  ndex_network_update_aspect          yes                  (x)               (x)               
  ndex_network_get_permission         yes                  X                 X                 only for users, different response
  ndex_network_update_permission      yes                  X                 X                 (only for users)
  ndex_network_delete_permission      yes                  X                 X                 only for users
  ndex_network_set_systemProperties   yes                  X                 X                 only readOnly
  ndex_network_update_profile         yes                  X                 X                 X
  ndex_network_get_provenance         no                   X                 X                 X
  ***Users***
  ndex_find_users                     no                   X                 X                 X
  ndex_find_user_byName               no                   X                 X                 
  ndex_find_user_byId                 no                   X                 X                 
  ndex_create_user                    yes                  X                 X                 
  ndex_delete_user                    yes                  X                 X                 
  ndex_update_user                    yes                  X                 X                 
  ndex_verify_user                    no                   X                 X                 
  ndex_user_change_password           yes                  X                 X                 
  ndex_user_mail_password             no                   X                 X                 
  ndex_user_forgot_password           no                   X                 X                 
  ndex_user_list_groups               yes                  X                 X                 
  ndex_user_show_group                yes                  X                 X                 
  ndex_user_list_permissions          yes                  X                 X                 
  ndex_user_show_permission           yes                  X                 X                 
  ndex_user_get_showcase              no                   X                 X                 
  ndex_user_get_networksummary        yes                  X                 X                 
  ***Groups***
  ndex_find_groups                    no                   X                 X                 X
  ndex_get_group                      no                   X                 X                 
  ndex_create_group                   yes                  X                 X                 
  ndex_delete_group                   yes                  X                 X                 
  ndex_update_group                   yes                  X                 X                 
  ndex_group_list_users               no                   X                 X                 
  ndex_group_set_membership           yes                  X                 X                 
  ndex_group_list_networks            no                   X                 X                 
  ndex_group_network_get_permission   no                   X                 X                 
  ----------------------------------- -------------------- ----------------- ----------------- -----------------
...
version 1.3, 2.0 and 2.1). By default, `ndex_connect()` uses the version defined
