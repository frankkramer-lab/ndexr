...
**Note: In future `ndexr` uses the `RCX` data model from the corresponding package (https://bioconductor.org/packages/RCX) to handle the networks!**
...
“ndexStatus”, “provenanceHistory” and “status”. 
Those aspects are removed automatically by the \link[RCX]{RCX-object} package.
